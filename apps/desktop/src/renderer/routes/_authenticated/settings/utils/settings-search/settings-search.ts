...
export const SETTING_ITEM_ID = {
	...
	TOOLS_SKILLS_LIBRARY: "tools-skills-library",
	TOOLS_SKILLS_IMPORT: "tools-skills-import",
	TOOLS_SKILLS_AUTOMATION_BINDINGS: "tools-skills-automation-bindings",
...
export const SETTING_ITEM_VARIANT: Record<SettingItemId, SettingVariant> = {
	...
	[SETTING_ITEM_ID.TOOLS_SKILLS_LIBRARY]: "shared",
	[SETTING_ITEM_ID.TOOLS_SKILLS_IMPORT]: "shared",
	[SETTING_ITEM_ID.TOOLS_SKILLS_AUTOMATION_BINDINGS]: "shared",
...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.TOOLS_SKILLS_LIBRARY,
		section: "toolsAndSkills",
		title: "Tools & Skills library",
		description: "Manage reusable Skill packages and CLI tools",
		keywords: [
			"tools",
			"skills",
			"skill",
	...
	{
		id: SETTING_ITEM_ID.TOOLS_SKILLS_IMPORT,
		section: "toolsAndSkills",
		title: "Import capability package",
		description: "Import a zip package with superset.capability.json",
		keywords: [
			"import",
			"zip",
			"manifest",
	...
	{
		id: SETTING_ITEM_ID.TOOLS_SKILLS_AUTOMATION_BINDINGS,
		section: "toolsAndSkills",
		title: "Automation tools and skills",
		description: "Pin package versions for Automation runs",
		keywords: [
			"automation",
			"automations",
			"schedule",
