...
import { Globe, MessageCirclePlus, SquareTerminal } from "lucide-react";
...
export function AddTabMenu({
	...
	return (
		<>
			<DropdownMenuItem className="gap-2" onSelect={onAddTerminal}>
				<SquareTerminal className="size-4" />
				<span>Terminal</span>
				<HotkeyMenuShortcut hotkeyId="NEW_GROUP" />
			</DropdownMenuItem>
			<DropdownMenuItem className="gap-2" onSelect={onAddChat}>
				<MessageCirclePlus className="size-4" />
				<span>Chat</span>
				<HotkeyMenuShortcut hotkeyId="NEW_CHAT" />
			</DropdownMenuItem>
			<DropdownMenuItem className="gap-2" onSelect={onAddBrowser}>
